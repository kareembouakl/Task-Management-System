...
def get_employee_tasks(employee_id):
    ...
    assigned_tasks = employee.tasks  # This uses the back_populates relationship from TaskAssignment to Employee
    return jsonify(taskassignments_schema.dump(assigned_tasks))
